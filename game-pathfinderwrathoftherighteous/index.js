// extensions/games/game-pathfinderwrathoftherighteous/index.ts
var path = require("path");
var { fs, types, util } = require("vortex-api");
var GAME_ID = "pathfinderwrathoftherighteous";
var NAME = "Pathfinder: Wrath	of the Righteous";
var STEAM_ID = "1184370";
var GOG_ID = "1207187357";
function findGame() {
...
async function resolveGameVersion(discoveryPath) {
  ...
  try {
    ...
    return segments[3] ? Promise.resolve(segments[3]) : Promise.reject(new util.DataInvalid("Failed to resolve version"));
  } catch (err) {
...
function main(context) {
  ...
  context.once(() => {
    if (context.api.ext.ummAddGame !== void 0) {
