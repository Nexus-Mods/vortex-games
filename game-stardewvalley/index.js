...
const path = require('path'), { clipboard } = require('electron'), rjson = require('relaxed-json'), { SevenZip } = vortex_api_1.util, { deploySMAPI, downloadSMAPI, findSMAPIMod } = require('./SMAPI'), { GAME_ID, _SMAPI_BUNDLED_MODS, getBundledMods } = require('./common');
...
function init(context) {
    ...
    context.once(() => {
        ...
        context.api.onAsync('added-files', (0, configMod_1.onAddedFiles)(context.api));
