...
// extensions/games/game-spyroreignitedtrilogy/index.ts
var import_path4 = __toESM(require("path"));
var import_vortex_api4 = require("vortex-api");

// extensions/games/game-spyroreignitedtrilogy/common.ts
var import_path = __toESM(require("path"));
var MOD_FILE_EXT = ".pak";
var GAME_ID = "spyroreignitedtrilogy";
var LO_FILE_NAME = "loadOrder.json";
function modsRelPath() {
  return import_path.default.join("falcon", "content", "paks", "~mods");
}

// extensions/games/game-spyroreignitedtrilogy/loadOrder.ts
var import_vortex_api2 = require("vortex-api");

// extensions/games/game-spyroreignitedtrilogy/util.ts
...
// extensions/games/game-spyroreignitedtrilogy/migrations.ts
...
function main(context) {
  ...
  context.registerLoadOrder({
    ...
    usageInstructions: "Re-position entries by drag and dropping them - note that the mod with the higher index value will win any conflicts."
  });
