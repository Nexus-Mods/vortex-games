...
function getMergedModNames(context) {
    return getMergeInventory(context)
        ...
        if (mergeEntry === undefined) {
            ...
            (0, vortex_api_1.log)('error', 'failed to retrieve merged mod names', inv);
            return Promise.resolve([]);
        }
