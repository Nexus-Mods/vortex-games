...
function importFromBG3MM(context) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const loadOrder = JSON.parse(data)["Order"];
...
function processLsxFile(api, lsxPath) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            //const loNode = (_g = (0, util_1.findNode)((_f = (_e = root === null || root === void 0 ? void 0 : root.children) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.node, 'Mods')) !== null && _g !== void 0 ? _g : { children: [] };
